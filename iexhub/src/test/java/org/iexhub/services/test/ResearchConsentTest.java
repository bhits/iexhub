...
public class ResearchConsentTest {
	...
	public void test() {
		...
		recipientResearcherPractitionerResource.addIdentifier().setSystem("NPI uri").setValue("NPI");
		...
		CodeableConceptDt researchStudy = new CodeableConceptDt("urn:oid:2.16.840.1.113883.6.1", "1111-1");
