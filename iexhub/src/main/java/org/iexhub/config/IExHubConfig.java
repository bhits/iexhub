...
public class IExHubConfig {
    ...
    public static final String IEXHUB_CONFIG_FILENAME_PROP_NAME = "iexhub.config.filename";
    public static final String DEFAULT_IEXHUB_CONFIG_FILENAME = "IExHub.properties";

    /**
     * Configuration location is externally configurable using
     * <code>{@value IEXHUB_CONFIG_LOCATION_PROP_NAME}</code> and <code>{@value IEXHUB_CONFIG_FILENAME_PROP_NAME}</code>
     * system properties. The external configuration file will be loaded from
     * <code>${{@value IEXHUB_CONFIG_LOCATION_PROP_NAME}}/${{@value IEXHUB_CONFIG_FILENAME_PROP_NAME}}</code> file.
     * <br/>
     * <p>The default values are:<ul>
     * <li> <code>{@value IEXHUB_CONFIG_LOCATION_PROP_NAME}</code>: {@value DEFAULT_IEXHUB_CONFIG_LOCATION}
     * <li> <code>{@value IEXHUB_CONFIG_FILENAME_PROP_NAME}</code>: {@value DEFAULT_IEXHUB_CONFIG_FILENAME}
     *
     * @see IExHubConfig#DEFAULT_IEXHUB_CONFIG_LOCATION
     * @see IExHubConfig#DEFAULT_IEXHUB_CONFIG_FILENAME
     */
    ...
    public static final String CONFIG_FILE = CONFIG_LOCATION + "/" + Optional.ofNullable(System.getProperty(IEXHUB_CONFIG_FILENAME_PROP_NAME)).orElse(DEFAULT_IEXHUB_CONFIG_FILENAME);
